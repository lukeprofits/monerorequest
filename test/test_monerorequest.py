...
class TestMoneroRequest(unittest.TestCase):
    ...
    def test_decode_monero_payment_request_v2(self):
        ...
        request_string = 'monero-request:2:'
        self.assertEqual(decode_monero_payment_request(request_string), payment_request)
